...
# Possibly use a pico and send the data to the pi via wifi or bluetooth, but that is a major TODO and should be done after the main functionality of the payload is complete.
class MoistureSensors:
    ...
    def read_moisture(self) -> float:
        ...
        return {"1": moisture_1, "2": moisture_2}
